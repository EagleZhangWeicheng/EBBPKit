...
+ (EBLSecurityResult *)aesEncrypt:(NSString *)data key:(NSString *)key{
    EBLSecurityResult * sha = [self sha384:key];
...
+ (EBLSecurityResult *)aesEncrypt:(NSString *)data hexKey:(NSString *)key hexIv:(NSString *)iv{
    EBLSecurityDecoder *decoder = [EBLSecurityDecoder new];
...
+ (EBLSecurityResult *)aesEncryptWithData:(NSData *)data key:(NSData *)key iv:(NSData *)iv{
    ...
    if ([iv length] != 16) {
        @throw [NSException exceptionWithName:@"EBL Security"
    ...
    if (cryptStatus == kCCSuccess) {
        EBLSecurityResult *result = [[EBLSecurityResult alloc] initWithBytes:buffer length:encryptedSize];
        free(buffer);
        return result;
    }else {
        free(buffer);
...
+ (EBLSecurityResult *)md5WithData:(NSData *)hashData{
    ...
    EBLSecurityResult *result = [[EBLSecurityResult alloc] initWithBytes:digest length:CC_MD5_DIGEST_LENGTH];
    free(digest);
    return result;
}
...
+ (EBLSecurityResult *)sha1WithData:(NSData *)hashData{
    ...
    EBLSecurityResult *result = [[EBLSecurityResult alloc] initWithBytes:digest length:CC_SHA1_DIGEST_LENGTH];
    free(digest);
...
+ (EBLSecurityResult *)sha224WithData:(NSData *)hashData{
    ...
    EBLSecurityResult *result = [[EBLSecurityResult alloc] initWithBytes:digest length:CC_SHA224_DIGEST_LENGTH];
    free(digest);
...
+ (EBLSecurityResult *)sha256WithData:(NSData *)hashData{
    ...
    EBLSecurityResult *result = [[EBLSecurityResult alloc] initWithBytes:digest length:CC_SHA256_DIGEST_LENGTH];
    free(digest);
...
+ (EBLSecurityResult *)sha384WithData:(NSData *)hashData{
    ...
    EBLSecurityResult *result = [[EBLSecurityResult alloc] initWithBytes:digest length:CC_SHA384_DIGEST_LENGTH];
    free(digest);
...
+ (EBLSecurityResult *)sha512WithData:(NSData *)hashData{
    ...
    EBLSecurityResult *result = [[EBLSecurityResult alloc] initWithBytes:digest length:CC_SHA512_DIGEST_LENGTH];
    free(digest);
...
@implementation EBLSecurityResult
...
// convert EBLSecurityResult to UTF8 string
- (NSString *)utf8String{
...
#pragma mark HEX
// convert EBLSecurityResult to HEX string
- (NSString *)hex{
    EBLSecurityEncoder *encoder = [EBLSecurityEncoder new];
...
#pragma mark Base64
// convert EBLSecurityResult to Base64 string
- (NSString *)base64{
    EBLSecurityEncoder *encoder = [EBLSecurityEncoder new];
...
@implementation EBLSecurityEncoder
...
@implementation EBLSecurityDecoder
